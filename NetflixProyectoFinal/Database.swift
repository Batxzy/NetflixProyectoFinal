...
var moviesDos:MoviesMovies = MoviesMovies(
    ...
    rating: 4.7,
    descripcion: "Este musical explora la alegría y el dolor de perseguir los sueños por medio de la historia de Mia, una aspirante a actriz, y Sebastian, un músico de jazz, quienes luchan por sobrevivir en Los Ángeles, una ciudad conocida por aplastar las esperanzas.")
...
var moviesTres:MoviesMovies = MoviesMovies(
    ...
    rating: 4.9,
    descripcion: "Un equipo de exploradores viaja más allá de esta galaxia a través de un recién descubierto agujero para descubrir si la humanidad tiene un futuro.")
...
var seriesDos:SeriesSeries = SeriesSeries(
    ...
    rating: 4.7,
    descripcion: "Cuando un chico llega a un pequeño pueblo mexicano, una profunda amistad florece con un niño local, y un oscuro secreto sella su vínculo para siempre.")
...
var seriesTres:SeriesSeries = SeriesSeries(
    ...
    rating: 4.9,
    descripcion: "Después de la extraña desaparición de un niño, un pueblo se encuentra ante un misterio que revela experimentos secretos, fuerzas sobrenaturales y a una niña muy especial.")
...
var seriesCuatro:SeriesSeries = SeriesSeries(
    ...
    rating: 4.9,
    descripcion: "Reunidos por la muerte de su padre, hermanos distanciados con poderes extraordinarios destapan secretos perturbadores... y una amenaza inminente contra la humanidad.")
...
var seriesCinco:SeriesSeries = SeriesSeries(
    ...
    rating: 4.4,
    descripcion: "Por más de una década, 17 adolescentes y jóvenes fueron asesinados por el criminal convicto Jeffrey Dahmer. ¿Cómo evitó ser capturado durante tanto tiempo?")
//*****************************************************************************+***********
